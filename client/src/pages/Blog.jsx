...
const Blog = () => {
  ...
  const fetchComments = async () =>{
    try {
      ...
      // FIX: Check error.response existance to avoid "undefined" crash
      if (error.response) {
  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        <p className='text-primary py-4 font-medium'>Pushlished on {Moment(data.createdAt).format('MMMM Do YYYY')}</p>
      ...
      <div className='px-5 max-w-5xl mx-auto my-10 mt-6'>
